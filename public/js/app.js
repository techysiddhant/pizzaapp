...
function initAdmin(socket) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/orders', {
    ...
    orderTableBody.innerHTML = markup; // console.log(markup)
  })["catch"](function (err) {
    console.log(err);
  });
...
var cartCounter = document.querySelector('#cartCounter'); // let deleteCart = document.querySelector('#deleteCartBtn');
// let addToCart = document.querySelectorAll('.add-to-cart')

var removeToCart = document.querySelectorAll(".remove-to-cart"); // function updateCart(pizza) {
...
updateStatus(order); // for mobile design
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkThePizzaApp"] = self["webpackChunkThePizzaApp"] || [];
